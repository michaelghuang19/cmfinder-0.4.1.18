...
struct histogram_s {
  double *histogram;		/* counts of hits                     */
...
extern void AddToHistogram(struct histogram_s *h, float sc,double weight);
...
extern int    EVDMaxLikelyFit(float *x, double *y, int n, 
			      float *ret_mu, float *ret_lambda);
extern int    EVDCensoredFit(float *x, double *y, int n, int z, float c, 
			     float *ret_mu, float *ret_lambda);
extern void   Lawless416(float *x, double *y, int n, float lambda, 
			 float *ret_f, float *ret_df);
extern void   Lawless422(float *x, double *y, int n, int z, float c,
