 ...
 * SVN $Id: parsetree.c,v 1.6 2007/06/07 18:15:23 yzizhen Exp $
 * 
		     ...
		     Parsetree_t **tr, int nseq, int do_full)
{
  ...
  /* "author" info */
  msa->au   = MallocOrDie(sizeof(char) * (strlen(INFERNAL07_PACKAGE_VERSION)+10));
  sprintf(msa->au, "Infernal %s", INFERNAL07_PACKAGE_VERSION);
